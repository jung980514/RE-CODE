  ...
  return (
    ...
    >
      <div className="flex flex-col items-center text-center">
        <div className="w-50 h-50 rounded-full bg-emerald-100 flex items-center justify-center mb-4">
          <Icon className="w-30 h-30 text-emerald-600" />
        </div>
        <h2 className="text-3xl font-bold text-gray-800 mb-2"
            style={{ fontFamily: "Paperlogy, sans-serif" }}>{title}</h2>
        <p className="text-gray-600 text-xl">{description}</p>
      </div>
      <div className="mt-4 text-emerald-600 text-lg font-figtree font-medium">바로가기</div>
    </motion.div>
  )
}
