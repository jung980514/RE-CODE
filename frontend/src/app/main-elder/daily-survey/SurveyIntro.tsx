      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="flex justify-center gap-8 mb-12">
          ...
          <div className="text-center">
            ...
            <p className="font-semibold text-blue-800 text-xl">{surveyInfo.totalQuestions}개 질문</p>
            <p className="text-blue-600 text-2xl">{surveyInfo.personalizedQuestions}</p>
          </div>

          {/* 음성 답변 - 연두색 */}
          <div className="text-center">
            <Mic className="w-12 h-12 text-green-400 mx-auto mb-2" />
            <p className="font-semibold text-green-600 text-xl">{surveyInfo.voiceAnswer}</p>
            <p className="text-green-500 text-2xl">{surveyInfo.voiceAnswerDesc}</p>
          </div>

          {/* 약 5분 - 보라(그대로) */}
          <div className="text-center">
            <Clock className="w-12 h-12 text-purple-600 mx-auto mb-2" />
            <p className="font-semibold text-purple-800 text-xl">{surveyInfo.estimatedTime}</p>
            <p className="text-purple-600 text-2xl">예상 소요 시간</p>
          </div>
        </div>
