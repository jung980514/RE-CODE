    ...
    <>
      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <p className={styles.heroSubtitle}>지금 리코드를 만나보세요!</p>
          <button
      ...
      <section className={styles.introduction}>
        <div className={styles.introductionContent}>
          <h2 className={styles.quote}>
            &ldquo;행복한 추억으로 오늘의 기억을 지켜주세요!&rdquo;
          </h2>
          <p className={styles.description}>
            RE:CORD는 사랑하는 사람들이 추억을 공유하며, 부모님・지인 등 소중한 분의 기억을 지켜주는 애플리케이션입니다.
            메모리는 회상요법(Reminiscence Therapy)을 기반으로 한 프로그램으로 추억이 담긴 사진・영상・메시지 등을 공유함으로써, 잊혀진 기억을 되살려주도록 설계되었습니다.
            <br /><br />
            메모리는 행복한 기억을 반복적으로 회상하게 해줌으로써, 기억력을 강화해주고 행복함을 느끼게 해줍니다. 기억력을 강화해주고 행복감을 느끼게 해줍니다. 부모님과 우리 가족의 행복, 메모리로 지키세요.
          </p>
        </div>
      </section>
      ...
      <section className={styles.necessity}>
        <h2 className={styles.sectionTitle}>RE:CORD란?</h2>
        <p className={styles.necessityText}>
        ...
        <h3 className={styles.slogan}>
          &ldquo;두뇌건강, 노년의 행복이 되다!&rdquo;
        </h3>
      </section>

      {/* Therapy Section */}
      <section className={styles.therapy}>
        <h2 className={styles.sectionTitle}>회상요법이란?</h2>
        <div className={styles.therapyContent}>
          <div className={styles.therapyText}>
