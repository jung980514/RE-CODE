...
export default function GuardianLinkPage() {
  ...
  const generateToken = async () => {
    try {
      const response = await fetch(`${NEXT_PUBLIC_BACKEND_URL}/api/link/`, {
        method: 'POST',
        credentials: 'include',
        cache: 'no-store',
      });
  ...
  const fetchPendingRequests = async () => {
    try {
      const response = await fetch(`${NEXT_PUBLIC_BACKEND_URL}/api/link/list`, {
        method: 'GET',
        credentials: 'include',
        cache: 'no-store',
      });
  ...
  const fetchLinkedGuardians = async () => {
    try {
      const response = await fetch(`${NEXT_PUBLIC_BACKEND_URL}/api/link/elder/list`, {
        method: 'GET',
        credentials: 'include',
        cache: 'no-store',
      });
